                    ...
                    <table className="table datatable">
                        <thead className="thead-light text-uppercase">
                            <tr>
                                ...
                                <th className="no-sort">Archived Date</th>
                            ...
                            <tr>
                                <td>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ms-2">
                                            <h6 className="fw-medium mb-1"><a href="employee-details.html">Thomas Ward</a></h6>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="action-item">
                                    ...
                                    <ul className="dropdown-menu p-2 rounded-2">
                                        <li>
                                            <a href="#" className="dropdown-item rounded-2"><i className="ti ti-creative-commons-sa me-2"></i>Restore User</a>
                                        </li>
                                        <li>
