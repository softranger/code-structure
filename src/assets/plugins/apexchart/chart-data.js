  ...
  var radialChart = {
      ...
      plotOptions: {
        radialBar: {
          ...
          track: {
            background: '#F3F4F6', // Background color for unfilled track
            strokeWidth: '100%',
      ...
      grid: {
        padding: {
          top: -20, // Remove extra padding at the top
          bottom: -40, // Remove extra padding at the bottom
          left: -40, // Remove extra padding on the left
          right: -10, // Remove extra padding on the right
        },
      },
      stroke: {
      ...
      series: [70, 70],
      labels: ['Production', 'RetuManual Time'],    
  }
...
chart.render().then(() => {
  ...
  const svg = document.querySelector("#production_chart .apexcharts-svg");
  if (svg) {
    svg.style.height = "230px"; // Ensure SVG matches the desired height
...
if ($('#time-chart').length > 0) {
  var sCol = {
    ...
    colors: ['#E8EEFE', '#E8EEFE', '#E8EEFE', '#4361ee', '#E8EEFE', '#4361ee',],
    states: {
      hover: {
          filter: {
              type: 'darken', // Options: 'none', 'lighten', 'darken'
...
if ($('#unproductivetime-chart').length > 0) {
  var sCol = {
    ...
    colors: ['#945CFF', '#F0ECFF', '#945CFF','#F0ECFF',],
    states: {
      hover: {
          filter: {
              type: 'darken', // Options: 'none', 'lighten', 'darken'
